...
public class ProcessItemBOMNotificationPortClient {
    private ProcessItemBOMNotification _port;
    private List<CredentialProvider> _credProviders;

    @Generated("Oracle JDeveloper")
    public ProcessItemBOMNotificationPortClient() throws Exception {
        Processitembomnotification_Client_Ep service = new Processitembomnotification_Client_Ep_Impl();
        _port = service.getProcessItemBOMNotification_Pt();
    }

    public static void main(String[] args) {
        try {
            ProcessItemBOMNotificationPortClient client = new ProcessItemBOMNotificationPortClient();
    ...
    @Generated("Oracle JDeveloper")
    public ProcessItemBOMNotification getPort() {
        return _port;
    }
    ...
    @Generated("Oracle JDeveloper")
    public ItemBOMNotificationResponse process(ItemBOMNotification payload) throws RemoteException {
        return getPort().process(payload);
    }

    @Generated("Oracle JDeveloper")
    public void processAsync(AsyncPreCallContext apc,
                             ItemBOMNotification payload) throws RemoteException {
