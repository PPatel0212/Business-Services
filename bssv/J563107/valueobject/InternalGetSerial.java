 ...
 */
public class InternalGetSerial extends ValueObject implements Serializable {
  /**
   * 2nd Item Number
   * <p>
  ...
  public InternalShowSerial getQueryResults(int i) {
    return (InternalShowSerial)queryResults.get(i);
  }
}
