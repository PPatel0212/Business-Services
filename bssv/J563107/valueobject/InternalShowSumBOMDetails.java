 ...
 */
public class InternalShowSumBOMDetails extends ValueObject implements Serializable {
  /**
  ...
  private ArrayList internalGetSerial = null;
  ...
  public void setInternalGetSerial(ArrayList internalGetSerial) {
    this.internalGetSerial = internalGetSerial;
  }

  public ArrayList getInternalGetSerial() {
    return internalGetSerial;
  }
  
  public InternalShowSerial getInternalGetSerial(int i) {
    if(this.internalGetSerial!= null){
     return (InternalShowSerial)internalGetSerial.get(i);
    }
    else {
      return null;
    }
