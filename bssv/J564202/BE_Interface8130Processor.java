...
import oracle.e1.bssvfoundation.impl.services.DBService;
 ...
 */
public abstract class BE_Interface8130Processor extends BusinessService {
    /**
    ...
    public static E1MessageList getPickSlipDetails(IContext context, IConnection connection, InternalGetPickSlipDetails internalVO) {
        ...
        selectFromF5642008(context, connection, internalVO);
    ...
    public static E1MessageList setPickSlipPrint(IContext context, IConnection connection, InternalGetSODetailsKey internalVO) {
        ...
        callInterfaceTo8130Website1(context, connection, internalVO);
    ...
    private static E1MessageList selectFromF5642008(IContext context, IConnection connection, InternalGetPickSlipDetails internalVO) {
        ...
        {new BSSVDBField("F5642008.UKID"), // Numeric - UniqueKeyIDInternal
         ...
         new BSSVDBField("F5642008.MERL"), // Character - FutureCharacter3
         new BSSVDBField("F5642008.ECOD") // Character - FutureCharacter3
        ...
        if (resultSet != null) {
            ...
            if (fieldMap != null && fieldMap.length > 0) {
                ...
                for (int i = 0; i < fieldMap.length; i++) {
                    ...
                    result.setF5642008_MERL(map.getValue("F5642008.MERL").toString());
                    result.setF5642008_ECOD((Date)map.getValue("F5642008.ECOD"));
     ...
     * messages. Returns null if there were no messages.
     */
    private static E1MessageList callInterfaceTo8130Website1(IContext context, IConnection connection, InternalGetSODetailsKey internalVO) {
        BSFNParameters bsfnParams = new BSFNParameters();

        // map input parameters from input value object
        bsfnParams.setValue("mnPickSlipNumber", internalVO.getQueryWhereFields().getF4211_PSN());
    
        bsfnParams.setValue("mnUniqueKeyIDInternal", new MathNumeric(0));
        ...
        internalVO.setCSuccessfullyProcessedYN(bsfnParams.getValue("cRecordSuccefullyUpdatedYN").toString());
        //return any errors, warnings, or informational messages to the caller
        return bsfnParams.getE1MessageList();
    }
}
