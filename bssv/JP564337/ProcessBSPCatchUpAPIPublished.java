...
public class ProcessBSPCatchUpAPIPublished extends PublishedBusinessService {
  ...
  /**
   * Published method for ProcessBSPCatchUpAPILaunch TODO: Document method
   * Acts as wrapper method, passing null context and null connection,
   * will call protected ProcessBSPCatchUpAPILaunch
   ...
   */
  public LaunchBSPCatchUpAPIReply ProcessBSPCatchUpAPILaunch(LaunchBSPCatchUpAPIRequest vo) throws BusinessServiceException {
    return ProcessBSPCatchUpAPILaunch(null,null,vo);
  }

  /**
   * Protected method for ProcessBSPCatchUpAPILaunchlished PublishedBusinessService. ProcessBSPCatchUpAPILaunch will call make calls to BusinessService classes
   ...
   * @throws BusinessServiceException
   */
  protected LaunchBSPCatchUpAPIReply ProcessBSPCatchUpAPILaunch(IContext context, IConnection connection, LaunchBSPCatchUpAPIRequest vo) throws BusinessServiceException {
    ...
    try {
      ...
      context = startPublishedMethod(context, "ProcessBSPCatchUpAPILaunch", vo);
      ...
      finishPublishedMethod(context, "ProcessBSPCatchUpAPILaunch");
      //return outVO, filled with return values and messages
      return confirmVO;
    } finally {
      //Call close to clean up all remaining connections and resources.
      close(context, "ProcessBSPCatchUpAPILaunch");
    }
  }
}
