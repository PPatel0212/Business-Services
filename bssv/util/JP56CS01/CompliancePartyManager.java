...
import be.e1.bssv.util.J56CS01.CompliancePartyMgr;
 ...
 */
public class CompliancePartyManager extends PublishedBusinessService
{
  /**
   * TODO: PublishedBusinessService Public Constructor
   */
  public CompliancePartyManager()
  {
  }

  /**
   * Published method for getComplianceParty TODO: Document method
   * Acts as wrapper method, passing null context and null connection,
   * will call protected getComplianceParty
   ...
   */
  public CompliancePartyReply getComplianceParty(CompliancePartyRequest vo) throws BusinessServiceException
  {
    return getComplianceParty(null, null, vo);
  }

  /**
   * Protected method for CompliancePartyManager PublishedBusinessService. getComplianceParty will call make calls to BusinessService classes
   ...
   * @throws BusinessServiceException
   */
  protected CompliancePartyReply getComplianceParty(IContext context, IConnection connection, CompliancePartyRequest vo) throws BusinessServiceException
  {
    ...
    try
    {
      ...
      context = startPublishedMethod(context, "getComplianceParty", vo);
      ...
      CompliancePartyVO cpVO = new CompliancePartyVO(vo);

      //TODO: Call BusinessService passing context, connection and internal VO
      messages.addMessages(CompliancePartyMgr.getComplianceParty(context, connection, cpVO));
      ...
      CompliancePartyReply confirmVO = new CompliancePartyReply(cpVO);
      confirmVO.setE1MessageList(messages);
      finishPublishedMethod(context, "getComplianceParty");
    ...
    finally
    {
      ...
      close(context, "getComplianceParty");
    }
  }
}
