...
public class GetGroupUserDataPortClient {
    private GetGroupUserData _port;
    private List<CredentialProvider> _credProviders;

    @Generated("Oracle JDeveloper")
    public GetGroupUserDataPortClient() throws Exception {
        Getgroupuserdata_Client_Ep service = new Getgroupuserdata_Client_Ep_Impl();
        _port = service.getGetGroupUserData_Pt();
    }

    public static void main(String[] args) {
        try {
            GetGroupUserDataPortClient client = new GetGroupUserDataPortClient();
    ...
    @Generated("Oracle JDeveloper")
    public GetGroupUserData getPort() {
        return _port;
    }
    ...
    @Generated("Oracle JDeveloper")
    public ADGroupUserDataReply process(ADGroupUserDataRequest payload) throws RemoteException {
        return getPort().process(payload);
    }

    @Generated("Oracle JDeveloper")
    public void processAsync(AsyncPreCallContext apc,
                             ADGroupUserDataRequest payload) throws RemoteException {
