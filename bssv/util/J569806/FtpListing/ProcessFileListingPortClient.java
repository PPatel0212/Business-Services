...
public class ProcessFileListingPortClient {
    private ProcessFileListing _port;
    private List<CredentialProvider> _credProviders;

    @Generated("Oracle JDeveloper")
    public ProcessFileListingPortClient() throws Exception {
        Processfilelisting_Client_Ep service = new Processfilelisting_Client_Ep_Impl();
        _port = service.getProcessFileListing_Pt();
    }

    public static void main(String[] args) {
        try {
            ProcessFileListingPortClient client = new ProcessFileListingPortClient();
    ...
    @Generated("Oracle JDeveloper")
    public ProcessFileListing getPort() {
        return _port;
    }
    ...
    @Generated("Oracle JDeveloper")
    public FileListingReply process(FileListingRequest payload) throws RemoteException {
        return getPort().process(payload);
    }

    @Generated("Oracle JDeveloper")
    public void processAsync(AsyncPreCallContext apc,
                             FileListingRequest payload) throws RemoteException {
