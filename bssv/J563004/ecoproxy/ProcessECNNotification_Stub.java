...
public class ProcessECNNotification_Stub 
     extends weblogic.wsee.jaxrpc.StubImpl
     implements be.e1.bssv.J563004.ecoproxy.ProcessECNNotification, /**/java.io.Serializable
{

  public ProcessECNNotification_Stub(weblogic.wsee.wsdl.WsdlPort port, 
                        weblogic.wsee.jaxrpc.ServiceImpl service) 
    throws javax.xml.rpc.ServiceException
  {
    super(port, be.e1.bssv.J563004.ecoproxy.ProcessECNNotification.class, service);
  }
  ...
  public be.e1.bssv.J563004.com.beav.e1.ecnnotification.ECNNotificationResponse process(be.e1.bssv.J563004.com.beav.e1.ecnnotification.ECNNotification payload) throws java.rmi.RemoteException {
    ...
    try {
      ...
      return (be.e1.bssv.J563004.com.beav.e1.ecnnotification.ECNNotificationResponse)_result;
    ...
    _setProperty(weblogic.wsee.async.AsyncConstants.OPERATION_NAME_PROPERTY,
                 "process");
    _setProperty(weblogic.wsee.async.AsyncConstants.RETURN_TYPE_PROPERTY, "be.e1.bssv.J563004.com.beav.e1.ecnnotification.ECNNotificationResponse");
    _args.add(payload);
  ...
  private Object writeReplace() throws java.io.ObjectStreamException {
    java.util.HashMap map = new java.util.HashMap();
            map.put("processECNNotification_pt", "ProcessECNNotification_Pt");
            
    return new weblogic.wsee.tools.clientgen.stubgen.StubSerialWrapper(
      "be.e1.bssv.J563004.ecoproxy.Processecnnotification_Client_Ep",
