...
public class FedExShipmentRequest_Stub 
     extends weblogic.wsee.jaxrpc.StubImpl
     implements be.e1.bssv.J564200.ProcessProxy.FedExShipmentRequest, /**/java.io.Serializable
{

  public FedExShipmentRequest_Stub(weblogic.wsee.wsdl.WsdlPort port, 
                        weblogic.wsee.jaxrpc.ServiceImpl service) 
    throws javax.xml.rpc.ServiceException
  {
    super(port, be.e1.bssv.J564200.ProcessProxy.FedExShipmentRequest.class, service);
  }
  ...
  public be.e1.bssv.J564200.com.beone.fedex.beshipments.ProcessShipmentReply process(be.e1.bssv.J564200.com.beone.fedex.beshipments.ProcessShipmentRequest payload) throws java.rmi.RemoteException {
    ...
    try {
      ...
      return (be.e1.bssv.J564200.com.beone.fedex.beshipments.ProcessShipmentReply)_result;
    ...
    _setProperty(weblogic.wsee.async.AsyncConstants.OPERATION_NAME_PROPERTY,
                 "process");
    _setProperty(weblogic.wsee.async.AsyncConstants.RETURN_TYPE_PROPERTY, "be.e1.bssv.J564200.com.beone.fedex.beshipments.ProcessShipmentReply");
    _args.add(payload);
  ...
  private Object writeReplace() throws java.io.ObjectStreamException {
    java.util.HashMap map = new java.util.HashMap();
            map.put("fedExShipmentRequest_pt", "FedExShipmentRequest_Pt");
            
    return new weblogic.wsee.tools.clientgen.stubgen.StubSerialWrapper(
      "be.e1.bssv.J564200.ProcessProxy.Fedexshipmentrequest_Client_Ep",
