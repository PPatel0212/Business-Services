...
public class IntDangerousGoodsShippersDeclarationDetail extends ValueObject implements Serializable
{
  ...
  public void copyToDangerousGoodsShippersDeclarationDetail(DangerousGoodsShippersDeclarationDetail outData)
  {
    if(outData != null)
    {
      if(this.format != null)
