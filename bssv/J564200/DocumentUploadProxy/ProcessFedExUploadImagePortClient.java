...
public class ProcessFedExUploadImagePortClient {
    private ProcessFedExUploadImage _port;
    private List<CredentialProvider> _credProviders;

    @Generated("Oracle JDeveloper")
    public ProcessFedExUploadImagePortClient() throws Exception {
        Processfedexuploadimage_Client_Ep service = new Processfedexuploadimage_Client_Ep_Impl();
        _port = service.getProcessFedExUploadImage_Pt();
    }

    public static void main(String[] args) {
        try {
            ProcessFedExUploadImagePortClient client = new ProcessFedExUploadImagePortClient();
    ...
    @Generated("Oracle JDeveloper")
    public ProcessFedExUploadImage getPort() {
        return _port;
    }
    ...
    @Generated("Oracle JDeveloper")
    public UploadImagesReply process(UploadImagesRequest payload) throws RemoteException {
        return getPort().process(payload);
    }

    @Generated("Oracle JDeveloper")
    public void processAsync(AsyncPreCallContext apc,
                             UploadImagesRequest payload) throws RemoteException {
