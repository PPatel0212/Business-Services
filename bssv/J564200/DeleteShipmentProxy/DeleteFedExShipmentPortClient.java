...
public class DeleteFedExShipmentPortClient {
    private DeleteFedExShipment _port;
    private List<CredentialProvider> _credProviders;

    @Generated("Oracle JDeveloper")
    public DeleteFedExShipmentPortClient() throws Exception {
        Deletefedexshipment_Client_Ep service = new Deletefedexshipment_Client_Ep_Impl();
        _port = service.getDeleteFedExShipment_Pt();
    }

    public static void main(String[] args) {
        try {
            DeleteFedExShipmentPortClient client = new DeleteFedExShipmentPortClient();
    ...
    @Generated("Oracle JDeveloper")
    public DeleteFedExShipment getPort() {
        return _port;
    }
    ...
    @Generated("Oracle JDeveloper")
    public ShipmentReply delete(DeleteShipmentRequest payload) throws RemoteException {
        return getPort().delete(payload);
    }

    @Generated("Oracle JDeveloper")
    public void deleteAsync(AsyncPreCallContext apc,
                            DeleteShipmentRequest payload) throws RemoteException {
        getPort().deleteAsync(apc, payload);
    }
}
